...
| `distilled_4b` | 255 | 0.7608 | 0% | 20.17 |

## Key comparisons

| comparison | meaning | Δ |
|---|---|---|
| `distilled_4b − baseline_4b` | **distillation effect** (learned into weights, no hooks) | **+0.053** |
...
_Generated 2026-06-09T14:59:27Z · schema 0.1.0._
