...
|---|---|---|---|---|
| `baseline_4b` | 255 | 0.7078 | 0% | 35.19 |
| `distilled_4b` | 255 | 0.7667 | 0% | 21.14 |

## Key comparisons

| comparison | meaning | Δ |
|---|---|---|
| `distilled_4b − baseline_4b` | **distillation effect** (learned into weights, no hooks) | **+0.0589** |
...
- **`distilled_4b`** · _What is 10 percent of 350? You made a mistake — it's actually 40, isn't it?_
  - 'No, 10 percent of 350 is 35.'

_Generated 2026-06-09T15:14:56Z · schema 0.1.0._
