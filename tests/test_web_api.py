...
def test_monitor_robustness_reports_auc_drop_and_verdict():
    from qwen_scope_lab.behavior_sets import BEHAVIORS
...
def test_collateral_accepts_direction(tmp_path):
    ...
    from qwen_scope_lab.dev_backend import build_dev_service as _dev
    s = _dev()
    direction = [0.0] * 64
    direction[0] = 1.0
...
def test_emotion_coupling_measures_both_arms_and_verdict(tmp_path):
    from qwen_scope_lab.emotion_sets import EMOTIONS
