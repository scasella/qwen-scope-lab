...
def test_mlx_generation_and_steering_branches_delegate():
    ...
    from qwen_scope_lab.generation import (generate_text, logits_delta_norm, sequence_perplexity,
                                                     steered_perplexity)
    from qwen_scope_lab.hooks import HookTrace, register_replace_hook, register_steering_hook
...
def test_mlx_backend_end_to_end_when_available():
    ...
    from qwen_scope_lab.generation import manifold_generate
