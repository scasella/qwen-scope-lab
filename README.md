...
- [The manifold atlas — twelve more clean concept geometries (write-up)](docs/writeups/manifold-atlas-3d.html) — interactive 3D plots of the real fitted geometry. A census of 20 new concepts found 12 clean manifolds (0 diffuse); the honest companion finding is that only 2 of 11 tested also *route*, so clean geometry ≠ clean control. Method: [`docs/experiments/MANIFOLD_ATLAS_CENSUS.md`](docs/experiments/MANIFOLD_ATLAS_CENSUS.md).
